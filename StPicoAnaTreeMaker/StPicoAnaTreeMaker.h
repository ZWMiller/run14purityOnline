...
class StPicoAnaTreeMaker : public StMaker {
    public:
        ...
        void setHFTTrackCut(Bool_t val){ mHFTTrackCut = val; }
        void setEPtCut(const Float_t min, const Float_t max){mEPtCut[0] = min; mEPtCut[1] = max; }
        void setEEtaCut(const Float_t min, const Float_t max){mEEtaCut[0] = min; mEEtaCut[1] = max; }
        ...
        void setDauEEtaCut(const Float_t min, const Float_t max){mDauEEtaCut[0] = min; mDauEEtaCut[1] = max; }
