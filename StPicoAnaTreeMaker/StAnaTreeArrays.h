...
enum anaTreeTypes {anaTreeEvent=0, anaTreeETrack, anaTreeMuTrack, anaTreeHTrack, 
    anaTreeEEPair, anaTreeEMuPair, anaTreeMuMuPair, anaTreeEmcTrigger, anaTreeMtdTrigger};
enum NAnaTreeArrays {
__NANATREEARRAYS__ = 9
};
